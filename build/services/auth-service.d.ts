...
export declare class AuthService {
    ...
    static udpateUserUserExperiment(): Promise<any>;
    ...
    static signup({ firstName, lastName, middleName, email, password, phone, company, customFields, gctoken, formFields, channelIds, }: SignupInterface): Promise<any>;
