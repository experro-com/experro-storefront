export declare class AnalyticsService {
    ...
    static initUserDetails(): void;
    static initAnalyticsSession(): void;
    static updateUserDetails(userDetails: any): Promise<boolean>;
    static trackPageView({ pageTitle, pageUrl, experiments }: {
        pageTitle: any;
        pageUrl: any;
        experiments: any;
    }): void;
    ...
    static trackProductSearched({ search_location, searchTerm, noOfResults, sku, products_detail, used_suggestion, search_source, facets, custom_ga4_data, experiments }: {
    ...
    static trackProductViewed({ sku, mode, searchTerm, search_location, category, collection, price, name, brand, productCategories, is_primary_algorithm, is_secondary_algorithm, algorithm, is_merchandising, rule, rule_type, widget_id, context_type, context_data, variant, rules, mode_details, facets, custom_ga4_data, experiments }: any): Promise<void>;
    static trackProductVarientViewed({ sku, variant_sku, mode, searchTerm, search_location, category, collection, price, name, brand, productCategories, is_primary_algorithm, is_secondary_algorithm, algorithm, is_merchandising, rule, rule_type, widget_id, context_type, context_data, variant, rules, mode_details, facets, experiments }: any): Promise<void>;
    static trackCategoryViewed({ categoryName, items, categoryId, provider_id, sku, products_detail, used_suggestion, search_source, facets, custom_ga4_data, experiments }: {
        categoryName: string;
        items: any;
        categoryId: string;
        provider_id: string;
    ...
    static trackCollectionViewed({ collectionName, items, collectionId, sku, products_detail, used_suggestion, search_source, facets, custom_ga4_data, experiments }: {
    ...
    static sanitizeProducts(products: any): any;
    static trackCartViewed({ totalValue, totalQuantity, cartId, baseAmount, cartAmount, discountAmount, items, products, custom_ga4_data, experiments }: any): Promise<void>;
    static trackCheckoutInitiated({ items, totalValue, cartId, totalQuantity, products, custom_ga4_data, experiments }: any): Promise<void>;
    static trackCheckoutCompleted({ items, totalValue, cartId, orderId, totalQuantity, subtotal_tax, currency_code, base_handling_cost, base_shipping_cost, discount_amount, handling_cost_ex_tax, shipping_cost_ex_tax, subtotal_ex_tax, total_ex_tax, wrapping_cost_ex_tax, payment_method, shipping_method, products, custom_ga4_data, experiments }: any): Promise<void>;
    ...
    static trackComponentViewed({ experiments, component_name, component_id }: {
        experiments: any;
        component_name: any;
        component_id: any;
    }): Promise<void>;
    static trackComponentClicked({ experiments, component_name, component_id }: {
        experiments: any;
        component_name: any;
        component_id: any;
    }): Promise<void>;
